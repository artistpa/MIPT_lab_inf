...
![graph](1/img/insert_comparison_size_from_0_to_100000_step_1000(1).png)

### График: среднее время вставки для vector и subvector от size в двойном логарифмическом масштабе
![graph](1/img/insert_comparison_size_from_0_to_100000_step_1000(2).png)

Из графиков видно, что для std::vector и для subvector асимптотика O(N). Это представляется ясно при построении графика в двойном логарифмическом масштабе (в легенде указаны угловые коэффициенты зависимости ln(t)(ln N)).
